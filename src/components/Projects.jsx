      ...
      <div id="projects" className="pt-20">
        ...
        <div className="mt-10 flex flex-col gap-y-10 sm:grid sm:grid-cols-12 gap-14 items-start">
          {datas.map((data, index) => (
            <div
              key={index}
              className={`col-span-12 sm:col-start-2 sm:col-end-12 lg:col-span-6 grid grid-cols-12 ${data.warnaCard} rounded-xl`}
            >
              ...
              <div className={`col-span-12 p-5 ${data.warnaTextCard}`}>
